                ...
                <SwiperSlide>
                    <div className='flex flex-row p-4 h-[30rem]'>
                        ...
                        <div className='flex flex-col justify-center w-1/3 px-4 rounded-r-lg bg-light-brown'>
                            ...
                            <div className='font-sans text-2xl font-semibold tracking-wide text-orange-gray'>We provide modern laptop</div>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='flex flex-row p-4 h-[30rem]'>
                        <div className='flex flex-col justify-center w-1/3 px-4 rounded-l-lg bg-light-brown'>
                            ...
                            <div className='font-sans text-2xl font-semibold tracking-wide text-right text-orange-gray'>We provide modern laptop</div>
                        </div>

                            ...
                            <tr className="bg-[#222E3A]/[6%] w-full">
                                ...
                                <th className="py-3  px-3 w-1/12 text-[#212B36] sm:text-base font-bold whitespace-nowrap group">
                                    <div className="flex items-center">
                                        ...
                                        <svg
                                            className={`w-4 h-4 cursor-pointer ${activeColumn?.includes("totalPrice")
                                                ? "text-black"
                                ...
                                <th className="py-3  px-3 w-1/12 text-[#212B36] sm:text-base font-bold whitespace-nowrap group">
                                    <div className="flex items-center">
                                        ...
                                        <svg
                                            className={`w-4 h-4 cursor-pointer ${activeColumn?.includes("orderStatus")
                                                ? "text-black"
                                                : "text-[#BCBDBE] group-hover:text-black rotate-180"
                            ...
                            {rowsToShow?.map((data, index) => (
                                <>
                                    ...
                                    >
                                        ...
                                        >
                                            {data?.shippingInfor?.lastname} {data?.shippingInfor?.firstname}
                                        </td>
                                        <td
                                            className={`py-2 px-3 font-normal text-base ${index == 0
                                                ? "border-t-1 border-black"
                                        ...
                                        >
                                            <EyeIcon
                                                ...
                                                onClick={() => { setOpenView(true); setInitP(data)  }}
                                            />
                                            <PencilSquareIcon
                                                className="w-8 h-8 hover:cursor-pointer hover:opacity-50 text-dark-purple"
                                                onClick={() => { setOpenUpdate(true); setId(data._id); }}
                                            />
                                        </td>
                                    </tr>
                                </>
...
`}
                        ...
                        <BasicModal open={openUpdate} onClose={() => setOpenUpdate(false)} >
                            <ChangeOrderStatus onClose={() => setOpenUpdate(false)} open={openUpdate} data={id}/>
                            {/* <UpdateProduct onClose={() => setOpenUpdate(false)} open={openUpdate} data={initP} /> */}
                        </BasicModal>
                        <BasicModal open={openView} onClose={() => setOpenView(false)} >
                            <OrderItemDetailAdmin onClose={() => setOpenView(false)} open={openView} data={initP} />
                        </BasicModal>
                    </div>
                </div>
            </div>

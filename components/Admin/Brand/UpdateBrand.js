...
const UpdateBrand = (props) => {
  ...
  if (props.open) return (
    <div className='absolute w-2/5 px-10 py-5 mt-4 -translate-x-1/2 -translate-y-1/2 bg-white min-w-fit top-1/2 left-1/2 rounded-xl'>
      <h3 className="mb-4 text-xl font-semibold tracking-wide">Sửa nhãn hàng</h3>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.title && <div className='mt-2 text-sm italic text-red-400 text-italic'>*Không được để trống tên nhãn hàng</div>}

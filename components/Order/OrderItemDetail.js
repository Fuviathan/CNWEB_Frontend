      ...
      <form onSubmit={handleSubmit(onSubmit)} className='p-6 border border-gray-200 rounded-lg'>
        <div className='flex items-center'>
          <div className='w-1/2 mr-8'>
            ...
            <input className='w-full p-2 mt-2 border border-gray-300 rounded-lg' disabled {...register('lastname', { required: true })} />
          </div>
          <div className='w-1/2 ml-8'>
            <label className='block mt-2'>Tên</label>
            <input className='w-full p-2 mt-2 border border-gray-300 rounded-lg' disabled {...register('firstname', { required: true })} />
          </div>
        </div>
        <label className='block mt-2'>Địa chỉ</label>
        <input className='w-full p-2 mt-2 border border-gray-300 rounded-lg' disabled {...register('address', { required: true })} />
        <div className='flex justify-between mt-2'>
          ...
          <div className='flex flex-col w-1/2 ml-8'>
            ...
            <input className='w-full p-2 mt-2 border border-gray-300 rounded-lg' disabled {...register('methodPayment', { required: true })} >
